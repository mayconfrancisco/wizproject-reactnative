...
export const reducer = createReducer(INITIAL_STATE, {
  ...
  // TODO MAYCON - interface otimista - atualizar a tela mesmo sem ter finalizado
  // a requisicao ao server - importante para nao ficar travando a tela do usuario
  // TODO MAYCON - Criar um updatefailure e retornar os itens caso de erro no sagas
